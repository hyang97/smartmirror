...
_Result = collections.namedtuple('_Result', ['transcript', 'response_audio', 'assistant_transcript'])
...
class AssistantSpeechRequest(GenericSpeechRequest):
    ...
    def __init__(self, credentials, model_id, device_id):
        ...
        self._transcript = None
        self._assistant_transcript = None
    ...
    def _create_config_request(self):
        ...
        # assist_config.screen_out_config.screen_mode = PLAYING # get visual output
    ...
    def _handle_response(self, resp):
        ...
        if resp.dialog_state_out.supplemental_display_text:
            self._assistant_transcript = resp.dialog_state_out.supplemental_display_text
    ...
    def _finish_request(self):
        ...
        return _Result(self._transcript, self._response_audio, self._assistant_transcript)
